...
class ConvertKitMigrator extends BaseMigrator
{
    public function getInfo()
    {
        return [
            'title'                  => 'ConvertKit',
            'description'            => 'Migrate your ConvertKit contacts and associate to FluentCRM',
            ...
            'field_map_info'         => 'Email Address and First name will be mapped automatically',
            'tags_map_info'           => 'Only Selected tags will be imported from ConvertKit',
            'credentials'            => [
                'api_key'    => '',
                'api_secret' => ''
            ],
            'credential_fields'      => [
                'api_key'    => [
                    ...
                    'data_type'   => 'text',
                    'type'        => 'input-text',
                    'inline_help' => 'You can find your API key at ConvertKit <a href="https://app.convertkit.com/account_settings/advanced_settings" rel="noopener" target="_blank">Account -> Settings -> Advanced</a>'
                ],
                'api_secret' => [
                    'label'       => 'API Secret',
                    ...
                    'data_type'   => 'password',
                    'type'        => 'input-text',
                    'inline_help' => 'You can find your API Secret key at ConvertKit Account -> Settings -> Advanced'
                ]
            ],
    ...
    public function getSummary($postedData)
    {
        ...
        $message = 'Based on your selections, ' . $tagCounts . ' tags and associate contacts will be imported from ConvertKit';
    ...
    public function runImport($postedData)
    {
        ...
        return [
            ...
            'message' => 'Importer is running now. '.( $import_tracker['current_index']+1 ) .' tags have been imported so far'
        ];
    }
