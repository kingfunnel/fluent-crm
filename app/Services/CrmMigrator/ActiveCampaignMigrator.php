...
class ActiveCampaignMigrator extends BaseMigrator
{
    public function getInfo()
    {
        return [
            ...
            'description'            => 'Transfer your ActiveCampaign tags and contacts to FluentCRM',
            ...
            'field_map_info'         => 'Email and main contact fields will be mapped automatically',
            'credential_fields'      => [
                'api_key' => [
                    'label'       => 'API Token',
                    'placeholder' => 'ActiveCampaign API Token',
                    'data_type'   => 'password',
                    'type'        => 'input-text',
                    'inline_help' => 'You can find your API key at Drip Profile -> User Info -> API Token'
                ],
                'api_url' => [
                    'label'       => 'API Access URL',
                    'placeholder' => 'API Access URL',
                    'data_type'   => 'url',
                    'type'        => 'input-text',
                    'inline_help' => 'You can find Account ID Settings -> Developer -> API Access'
                ]
            ],
    ...
    public function getSummary($postedData)
    {
        ...
        $message = 'Based on your selections ' . $listCounts . ' lists and associate contacts  will be imported';
    ...
    public function runImport($postedData)
    {
        ...
        return [
            ...
            'has_more'      => true,
            'hide_progress' => true,
            'message'       => ($page * 20) . ' contacts has been imported so far.'
        ];
    }
