...
class DripMigrator extends BaseMigrator
{
    public function getInfo()
    {
        return [
            'title'                  => 'Drip',
            'description'            => 'Transfer your Drip tags and contacts to FluentCRM',
            ...
            'credential_fields'      => [
                ...
                'account_id' => [
                    ...
                    'data_type'   => 'text',
                    'type'        => 'input-text',
                    'inline_help' => 'You can find Account ID Settings -> General Info -> Account ID'
                ]
            ],
    ...
    public function getSummary($postedData)
    {
        ...
        $message = 'Based on your selections ' . $meta['total_count'] . ' contacts will be imported';
