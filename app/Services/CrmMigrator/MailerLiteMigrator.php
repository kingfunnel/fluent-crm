...
class MailerLiteMigrator extends BaseMigrator
{
    public function getInfo()
    {
        return [
            'title'                  => 'MailerLite',
            'description'            => 'Migrate your MailerLite contacts and associate to FluentCRM',
            ...
            'tags_map_info'           => 'Only Selected Groups will be imported from MailerLite',
            'credentials'            => [
                'api_key' => ''
            ],
            'credential_fields'      => [
                'api_key' => [
                    ...
                    'data_type'   => 'password',
                    'type'        => 'input-text',
                    'inline_help' => 'You can find your API key at MailerLite <a href="https://app.mailerlite.com/integrations/api/" target="_blank" rel="noopener">Account -> Integrations -> Developer API</a>'
                ]
            ],
    ...
    public function getSummary($postedData)
    {
        ...
        $message = 'Based on your selections, ' . $tagCounts . ' groups and associate contacts will be imported from MailerLite';
