...
class TransStrings
{
    ...
    public static function getStrings()
    {
        return [
            ...
            'All Administrators automatically will get full access of FluentCRM' => __('All Administrators automatically will get full access of FluentCRM', 'fluent-crm'),
            'Add New Manager'                                                    => __('Add New Manager', 'fluent-crm'),
            ...
            'Awesome! No one unsubscribed from this campaign' => __('Awesome! No one unsubscribed from this campaign', 'fluent-crm'),
            ...
            'Invalid selection of lists and tags in contacts included.' => __('Invalid selection of lists and tags in contacts included.', 'fluent-crm'),
            ...
            'Are you sure, you want to remove these subscribers from this sequence?' => __('Are you sure, you want to remove these subscribers from this sequence?', 'fluent-crm'),
            ...
            'You may change the trigger for this automation. Once you change, Please reconfigure the trigger settings' => __('You may change the trigger for this automation. Once you change, Please reconfigure the trigger settings', 'fluent-crm'),
            ...
            'To Activate this module please upgrade to pro' => __('To Activate this module please upgrade to pro', 'fluent-crm'),
            'Step 1'        => __('Step 1', 'fluent-crm'),
            'Step 2'        => __('Step 2', 'fluent-crm'),
            'meh meh meh meh meh' => __('meh meh meh meh meh', 'fluent-crm'),
            'Added'         => __('Added', 'fluent-crm'),
            'Send Emails with Multiple Subject Line (A/B) test' => __('Send Emails with Multiple Subject Line (A/B) test', 'fluent-crm'),
            'You can split test your Email Subject Line and Test which Subject Lines got more open and click rate. This is a pro feature' => __('You can split test your Email Subject Line and Test which Subject Lines got more open and click rate. This is a pro feature', 'fluent-crm'),
            ...
            'Use your dynamic segments to broadcast Email Campaigns' => __('Use your dynamic segments to broadcast Email Campaigns', 'fluent-crm'),
            ...
            'Simple enough to be quick to use, but powerful enough to really filter down your contacts into target segments', 'fluent-crm' => __('Simple enough to be quick to use, but powerful enough to really filter down your contacts into target segments', 'fluent-crm'),
            ...
            'Send Sequence/Drip emails to your subscribers with Email Sequence Module' => __('Send Sequence/Drip emails to your subscribers with Email Sequence Module', 'fluent-crm'),
            ...
            'You can not change the slug once save a custom field' => __('You can not change the slug once save a custom field', 'fluent-crm'),
            ...
            'Please specify if you want to let your subscribers manage the associate lists or not' => __('Please specify if you want to let your subscribers manage the associate lists or not', 'fluent-crm'),
            'Provide Valid Email Address that will be used in reply to (Optional)' => __('Provide Valid Email Address that will be used in reply to (Optional)', 'fluent-crm'),
            ...
            'A double optin email will be sent automatically' => __('A double optin email will be sent automatically', 'fluent-crm'),
            'Syncing may take few seconds to minutes based on your customers size in' => __('Syncing may take few seconds to minutes based on your customers size in', 'fluent-crm'),
            'click here'            => __('click here', 'fluent-crm'),
            'to re-sync the data again' => __('to re-sync the data again', 'fluent-crm'),
            'Please do not close this window or navigate to other page' => __('Please do not close this window or navigate to other page', 'fluent-crm'),
            'Data syncing has been completed. Please reload this page now' => __('Data syncing has been completed. Please reload this page now', 'fluent-crm'),
            ...
            'Collect and segment email contacts from wooCommerce checkout and send emails. Run funnels, segment your customers into FluentCRM' => __('Collect and segment email contacts from wooCommerce checkout and send emails. Run funnels, segment your customers into FluentCRM', 'fluent-crm'),
            ...
            'Please Provide a license key of FluentCRM - Email Marketing Addon' => __('Please Provide a license key of FluentCRM - Email Marketing Addon', 'fluent-crm'),
            'Purchase one here' => __('Purchase one here', 'fluent-crm'),
            'Something is wrong!' => __('Something is wrong!', 'fluent-crm'),
            'Please Provide Email address of your existing system user' => __('Please Provide Email address of your existing system user', 'fluent-crm'),
            ...
            'Looks like you did not have any additional Manager yet. Please create a manager (non administrator role) first for FluentCRM' => __('Looks like you did not have any additional Manager yet. Please create a manager (non administrator role) first for FluentCRM', 'fluent-crm'),
            ...
            'Use Basic Authorization for REST API requests. Please check the official documentation for more details' => __('Use Basic Authorization for REST API requests. Please check the official documentation for more details', 'fluent-crm'),
            'In' => __('In', 'fluent-crm'),
            ...
            'Not Working. Please make sure your server has this request type enabled' => __('Not Working. Please make sure your server has this request type enabled', 'fluent-crm'),
            'FluentSMTP - The ultimate SMTP & Email Service Connection Plugin for WordPress' => __('FluentSMTP - The ultimate SMTP & Email Service Connection Plugin for WordPress', 'fluent-crm'),
            ...
            'Your WordPress & FluentCRM is set to send using FluentSMTP Plugin' => __('Your WordPress & FluentCRM is set to send using FluentSMTP Plugin', 'fluent-crm'),
            ...
            'Looks like your FluentSMTP plugin is not configured yet' => __('Looks like your FluentSMTP plugin is not configured yet', 'fluent-crm'),
            ...
            'Copy the webhook URL you want to send your POST request to.' => __('Copy the webhook URL you want to send your POST request to.', 'fluent-crm'),
            ...
            'Extend FluentCRM functionalities and supercharge your email marketing and automation' => __('Extend FluentCRM functionalities and supercharge your email marketing and automation', 'fluent-crm'),
            'Supercharge your Email Marketing and Automation with FluentCRM Pro' => __('Supercharge your Email Marketing and Automation with FluentCRM Pro', 'fluent-crm'),
            ...
            'You can subscribe to our bi-monthly newsletter where we will email you all about FluentCRM.' => __('You can subscribe to our bi-monthly newsletter where we will email you all about FluentCRM.', 'fluent-crm'),
            'Install Fluent Forms Plugin for Lead collections Forms.' => __('Install Fluent Forms Plugin for Lead collections Forms.', 'fluent-crm'),
            ...
            'Allow FluentCRM to collect non-sensitive diagnostic data and usage information.' => __('Allow FluentCRM to collect non-sensitive diagnostic data and usage information.', 'fluent-crm'),
            ...
            'We will send marketing tips and advanced usage of FluentCRM (Monthly)' => __('We will send marketing tips and advanced usage of FluentCRM (Monthly)', 'fluent-crm'),
            ...
            'These tags will be applied to the contact whenever this link is clicked' => __('These tags will be applied to the contact whenever this link is clicked', 'fluent-crm'),
            'These Lists will be applied to the contact whenever this link is clicked' => __('These Lists will be applied to the contact whenever this link is clicked', 'fluent-crm'),
            'These tags will be removed from the contact whenever this link is clicked' => __('These tags will be removed from the contact whenever this link is clicked', 'fluent-crm'),
            'These Tags will be removed to a contact whenever this link is clicked' => __('These Tags will be removed to a contact whenever this link is clicked', 'fluent-crm'),
            ...
            'Add Conditional Action, apply rules and split your automation funnel' => __('Add Conditional Action, apply rules and split your automation funnel', 'fluent-crm'),
            ...
            'will be shown here, Currently no purchase history found for this contact' => __('will be shown here, Currently no purchase history found for this contact', 'fluent-crm'),
            ...
            "It’s completely optional and shouldn’t take longer than two minutes." => __("It’s completely optional and shouldn’t take longer than two minutes.", "fluent-crm"),
